  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12 space-y-8">
        ...
        <SEOContent>
          ...
          <div className="prose prose-gray max-w-none space-y-4">
            <p className="text-gray-600">
              Cria combinações aleatórias para todas as loterias da Caixa.
              Selecione o jogo e clique em &quot;Gerar Números&quot; para obter
              uma combinação válida.
            </p>
            <p className="text-gray-600">
              Para jogos com seleção variável, como a Mega-Sena (6 a 20
              números) e a Lotofácil (15 a 20 números), você escolhe quantos
              números gerar. Mais números = aposta mais cara, mas com mais
              chances.
            </p>
            <p className="text-gray-600">
              O gerador usa a API de criptografia do navegador para
              aleatoriedade real. As últimas 5 combinações ficam salvas.
            </p>
            <p className="text-gray-600">
              Todas as combinações têm a mesma chance de sair. Loterias são
              jogos de acaso. Jogue com responsabilidade.
            </p>
          </div>
        ...
        <ToolContentSections toolName="Gerador de Números" content={TOOL_CONTENT.gerador} />
      </div>
    </>
  );
}
