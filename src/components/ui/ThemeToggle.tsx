...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      title="Alternar tema"
      className="fixed bottom-4 left-4 z-50 flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 shadow-lg transition-colors hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600"
    >
      {dark ? (
