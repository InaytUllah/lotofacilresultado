...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/acumulados', label: 'Loterias Acumuladas' },
      { href: '/previsoes', label: 'Previsões' },
      { href: '/estatisticas', label: 'Estatísticas' },
      { href: '/bolao', label: 'Calculadora de Bolão' },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/dicas-para-apostar', label: 'Dicas para Apostar' },
      { href: '/probabilidades', label: 'Probabilidades' },
      { href: '/como-resgatar-premio', label: 'Como Resgatar Prêmio' },
      { href: '/glossario', label: 'Glossário de Loteria' },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/onde-vai-o-dinheiro', label: 'Para Onde Vai o Dinheiro' },
